...
```bash
git config --global user.name "Mohit Raj"
git config --global user.email "mohitraj@gamil.com"
```
...
1. **Generate SSH Key:**
   ...
   ```bash
   ssh-keygen -t ed25519 -C "mohitrajgma@gmail.com"
   ```
...
git remote add origin git@github.com:example/my-first-repo.git
